      ...
      >
        ...
        <div className=" flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2">
          ...
          <p className={`${styles.paragraph} ml-2`}>
            ...
            <span className="text-white 20">Unreal</span> projects{" "}
        ...
        <div className=" flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2">
          <img src={check} alt="check" className="w-[32px] h-[32px] " />
          <p className={`${styles.paragraph} ml-2`}>
            <span className="text-white 20">React, Firebase, Ionic, .Net </span>{" "}
            developer with{" "}
        ...
        <div className=" flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2">
          <img src={check} alt="check" className="w-[32px] h-[32px] " />
          <p className={`${styles.paragraph} ml-2`}>
            <span className="text-white 20">Kotlin, Flutter, Java, Python</span>{" "}
            with <span className="text-white 20">basic knowledge</span>{" "}
          </p>
        </div>
        ...
        <p className={` ${styles.paragraph} max-w-[470px] mt-5`}>
          Ambitious, heatedly, most likely to fit your needs. Looking for a team
          and job which will allow me to get experience and push my passions to
          the limit.
        </p>
      </div>
